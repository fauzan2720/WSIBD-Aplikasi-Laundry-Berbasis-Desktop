 ...
 * @author Fauzan
 */
public class Pelanggan_Baru extends javax.swing.JFrame {

    /**
     * Creates new form hal_das
     */
    public Pelanggan_Baru() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Pelanggan_Baru.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Pelanggan_Baru().setVisible(true);
            }
        });
    }
